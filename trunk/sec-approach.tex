...
When the Learning phase terminates, both the branching policy and the predictor apply to choose and to skip query nodes, respectively. The effect of branching with and without the predictor is shown in Fig.~\ref{fig:pred}. 
